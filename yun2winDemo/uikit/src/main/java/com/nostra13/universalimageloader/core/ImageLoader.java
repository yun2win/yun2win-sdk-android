...
public class ImageLoader {
	 ...
	 */
	public void displayImage(String uri,String access_token, ImageAware imageAware) {
		displayImage(uri,access_token, imageAware, null, null, null);
	}
	 ...
	 * @throws IllegalArgumentException if passed <b>imageAware</b> is null
	 */
	public void displayImage(String uri, String access_token,ImageAware imageAware, ImageLoadingListener listener) {
		displayImage(uri,access_token, imageAware, null, listener, null);
	}
	 ...
	 * @throws IllegalArgumentException if passed <b>imageAware</b> is null
	 */
	public void displayImage(String uri, String access_token,ImageAware imageAware, DisplayImageOptions options) {
		displayImage(uri,access_token, imageAware, options, null, null);
	}
	...
	public void displayImage(String uri,String access_token, ImageAware imageAware, DisplayImageOptions options,
		...
		displayImage(uri, access_token, imageAware, options, listener, null);
	}
           ...
           String downuri = uri;
			if(uri.indexOf("file://")==-1){
				if(!StringUtil.isEmpty(access_token)) {
					downuri = downuri + access_token;
				}
		   }
			ImageLoadingInfo imageLoadingInfo = new ImageLoadingInfo(downuri, imageAware, targetSize, memoryCacheKey,
					options, listener, progressListener, engine.getLockForUri(uri));
	 ...
	 */
	public void displayImage(String uri,String access_token, ImageView imageView) {
		displayImage(uri,access_token, new ImageViewAware(imageView), null, null, null);
	}
	 ...
	 * @throws IllegalArgumentException if passed <b>imageView</b> is null
	 */
	public void displayImage(String uri,String access_token, ImageView imageView, DisplayImageOptions options) {
		displayImage(uri,access_token, new ImageViewAware(imageView), options, null, null);
	}
	 ...
	 * @throws IllegalArgumentException if passed <b>imageView</b> is null
	 */
	public void displayImage(String uri,String access_token, ImageView imageView, ImageLoadingListener listener) {
		displayImage(uri,access_token, new ImageViewAware(imageView), null, listener, null);
	}
	...
	public void displayImage(String uri,String access_token, ImageView imageView, DisplayImageOptions options,
			ImageLoadingListener listener) {
		displayImage(uri,access_token, imageView, options, listener, null);
	}
	...
	public void displayImage(String uri,String access_token, ImageView imageView, DisplayImageOptions options,
			ImageLoadingListener listener, ImageLoadingProgressListener progressListener) {
		displayImage(uri,access_token, new ImageViewAware(imageView), options, listener, progressListener);
	}
	 ...
	 * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	public void loadImage(String uri,String access_token, ImageLoadingListener listener) {
		loadImage(uri,access_token, null, null, listener, null);
	}
	 ...
	 * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	public void loadImage(String uri,String access_token, ImageSize targetImageSize, ImageLoadingListener listener) {
		loadImage(uri,access_token, targetImageSize, null, listener, null);
	}
	 ...
	 * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	public void loadImage(String uri,String access_token, DisplayImageOptions options, ImageLoadingListener listener) {
		loadImage(uri,access_token, null, options, listener, null);
	}
	...
	public void loadImage(String uri,String access_token, ImageSize targetImageSize, DisplayImageOptions options,
			ImageLoadingListener listener) {
		loadImage(uri,access_token, targetImageSize, options, listener, null);
	}
	 ...
	 * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	public Bitmap loadImageSync(String uri,String access_token) {
		return loadImageSync(uri,access_token, null, null);
	}
	 ...
	 * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	public Bitmap loadImageSync(String uri,String access_token, DisplayImageOptions options) {
		return loadImageSync(uri,access_token, null, options);
	}
	 ...
	 * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	public Bitmap loadImageSync(String uri,String access_token, ImageSize targetImageSize) {
		return loadImageSync(uri,access_token, targetImageSize, null);
	}
	 ...
	 * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	public Bitmap loadImageSync(String uri,String access_token, ImageSize targetImageSize, DisplayImageOptions options) {
		if (options == null) {
			options = configuration.defaultDisplayImageOptions;
		}
		...
		loadImage(uri,access_token, targetImageSize, options, listener);
