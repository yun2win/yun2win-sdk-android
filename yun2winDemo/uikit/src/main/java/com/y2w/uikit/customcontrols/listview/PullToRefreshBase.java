...
import com.y2w.uikit.customcontrols.listview.internal.FlipLoadingLayout;
import com.y2w.uikit.customcontrols.listview.internal.LoadingLayout;
import com.y2w.uikit.customcontrols.listview.internal.RotateLoadingLayout;
import com.y2w.uikit.customcontrols.listview.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	protected final void setHeaderScroll(int value) {
		...
		if (mLayoutVisibilityChangesEnabled) {
			...
			if(!PullToRefreshListView.isFooterLoadingViewAble){
				mFooterLayout.setVisibility(View.INVISIBLE);
				mHeaderLayout.setVisibility(View.INVISIBLE);
			}
		}
