...
public class FileUtil {
    ...
    public static void fileCopy(String fromFile, String toFile)
    {
        ...
        try {
            java.io.FileInputStream fosfrom = new java.io.FileInputStream(fFile);
            java.io.FileOutputStream fosto = new FileOutputStream(tFile);
    ...
    //打开文件时调用
    public static void openFile(Context context,String filesPath) {

        if(context == null || StringUtil.isEmpty(filesPath)){
            return;
        }
    ...
    //显示打开方式
    private void show(Context context,String filesPath){
        Intent intent = new Intent();
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        intent.setAction(Intent.ACTION_VIEW);
        context.startActivity(showOpenTypeDialog(filesPath));
