...
import com.y2w.uikit.common.CheckedImageButton;
import com.y2w.uikit.frame.IEmoticonCategoryChanged;
import com.y2w.uikit.frame.IEmoticonSelectedListener;
...
public class EmoticonPickerView extends LinearLayout implements IEmoticonCategoryChanged {
    ...
    private LinearLayout pageNumberLayout;//ҳ�沼��
    ...
    private void init(Context context) {
        ...
        inflater.inflate(R.layout.lyy_emoji_layout, this);
    }
